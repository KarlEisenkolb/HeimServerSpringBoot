...
public class ExtractJsonData {
    ...
    private static final Logger log = LoggerFactory.getLogger(ExtractJsonData.class);
    ...
    public static Weather_current_entity extractData_current(String jsonResponse) {
        ...
        try {
            ...
            log.warn(" Problem parsing JSON current results. " + e.getMessage());
        }
    ...
    public static List<WeatherForecast_hourly_entity> extractAllData_hourly(String jsonResponse) {
        ...
        try {
            ...
            log.warn(" Problem parsing JSON hourly results. " + e.getMessage());
        }
        return listHourly;
    }
    ...
    public static List<WeatherForecast_daily_entity> extractAllData_daily(String jsonResponse) {
        ...
        try {
            ...
            log.warn(" Problem parsing JSON daily results. " + e.getMessage());
        }
        return listDaily;
    }
}
